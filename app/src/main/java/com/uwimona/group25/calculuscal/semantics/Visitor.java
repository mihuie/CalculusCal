...
public interface Visitor<S, T> {
    ...
    public T visitExpCos(ExpCos exp, S arg) throws SmplException;
    public T visitExpTan(ExpTan exp, S arg) throws SmplException;
    ...
    public T visitExpIntegrate(ExpIntegrate exp, S arg) throws SmplException;
    public T visitExpTaylor(ExpTaylor exp, S arg) throws SmplException;
    public T visitExpContinuity(ExpContinuity exp, S arg) throws SmplException;
    ...
    public T visitExpLog(ExpLog exp, S arg) throws SmplException;

    public T visitExpFactorial(ExpFactorial exp, S arg) throws SmplException;

    public T visitExpRoot(ExpRoot exp, S arg) throws SmplException;
